...
$('presentations').addEventListener('click',()=>{const list=node('nav','chapter-list');list.setAttribute('aria-label','Training presentations');const options=[[null,null,'Daily framework · reusable'],[1,'3','Wave 2 · Squad 1 · Day 3'],[1,'4','Wave 2 · Squad 1 · Day 4'],[1,'5','Wave 2 · Squad 1 · Day 5'],[1,'1','Squad 1 · Day 1 · Reference'],[1,'2','Squad 1 · Day 2 · Reference'],...['1','2','3','4','5'].map(key=>[2,key,'Squad 2 · New training · Day '+key]),['lesson','daily-brief','Squad 1 · Day 5 · alternative · Build the daily brief agent']];for(const [squad,key,label] of options){const a=node('a','chapter-link',label);a.href=squad==='lesson'?'?lesson='+key+'#1':squad?'?squad='+squad+'&day='+key+'#1':'./#1';if((squad==='lesson'&&key===lessonKey)||(squad!=='lesson'&&squad===selectedSquad&&key===dayKey&&!lessonKey)||(!squad&&!day))a.setAttribute('aria-current','page');list.append(a);}openPanel('Choose a presentation',list);});
